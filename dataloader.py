...
class myDataLoader():
	...
	@classmethod
	def getDataLoaders(self, path_low='data/low', path_high='data/high', batch_size=4, train_size=0.9, val_size=0.05):
		...
		# Getting sets
		train_set, val_set, test_set = random_split(my_dataset, [num_train, num_val, num_test])
